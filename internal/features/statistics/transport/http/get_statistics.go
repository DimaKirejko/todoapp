...
// @Description Отримати статистику
// @Tags statistics
// @Produce json
// @Param user_id query int false "фільтрація користувача по user id"
// @Param from query string false "початок проміжку заданий датою (включно) YYYY-MM-DD"
// @Param to query string false "кінець проміжку заданий датою (не включно) YYYY-MM-DD"
// @Success 200 {object} GetStatisticsResponse "Успішно отримана статистика"
